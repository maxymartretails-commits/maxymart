...
import { useDeleteProductsMutation } from "@/lib/slices/productsApiSlice";
import toast from "react-hot-toast";
import { useDeleteSubCategoryMutation } from "@/lib/slices/subCategoryApiSlice";
...
const DeleteSubCategory: React.FC<DeleteSubCategoryProps> = ({
  isOpen,
  onClose,
  details,
}) => {
  ...
  const handleDelete = async () => {
    await deleteSubCategory({ id: details?.id })
      .then(() => {
